...
public class FeatureService implements IBaseService<FeatureDTO, Long>, IModelMapper<FeatureDTO, Feature> {
    ...
    public FeatureDTO createFromE(Feature feature) {
        ...
        FeatureType featureType = featureTypeRepository.findById(feature.getFeaturetype().getFeatureTypeId()).get();
        featureDTO.setUnit(featureType.getUnit());
        featureDTO.setFeatureTypeName(featureType.getName());
        return featureDTO;
    }
